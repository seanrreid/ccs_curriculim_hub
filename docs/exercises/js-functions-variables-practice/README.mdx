...
- Make a new folder called `js-functions-exercise`
- Initialize a new git repository in this folder
- Make a folder called `js`
- Create an `index.html` file in the root of `js-functions-exercise`
...
- Add a _new_ function called `cook()`.  Have it accept a parameter called `cookName`, and then callback to `marinaSauce()` passing the `cookName` value from `cook` into `marinaraSauce`.
...
| :memo: | [JavaScript Callbacks](/docs/lessons/solving-problems-using-code-js/callbacks) |
