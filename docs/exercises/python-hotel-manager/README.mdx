---
title: Python Hotel Management App
sidebar_label: Python Hotel Manager
sidebar_position: 1.08
---

Use this exercises to practice working with Lists, Dictionaries, Functions and Loops.

## Must Haves

- Create a new folder, initialize a git repository
- Create a file called `hotel_manager.py`
