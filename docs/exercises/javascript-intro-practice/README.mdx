...
- They share quite a few similarities to Lists in Python
...
- Objects are collections of key/value pairs. They are similar (not the same!) to Dictionaries in Python
