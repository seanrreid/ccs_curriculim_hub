...
- Make a new folder called `js-intro-exercise`
- Initialize a new git repository in this folder
- Make a folder called `js`
- Create an `index.html` file in the root of `js-intro-exercise`
- Create a `scripts.js` file in the `js` folder
- Copy/Paste the code example into `scripts.js`

:::info
Make sure your `index.html` has a `script` tag that links to the `js/scripts.js`
:::
...
- They share quite a few similarities to [Lists in Python](/docs/syllabus/#programming-patterns)
...
- Objects are collections of key/value pairs. They are similar (not the same!) to [Dictionaries in Python](/docs/syllabus/#programming-patterns)
